...
and heteroskedastic Student-t processes surrogates on a dense grided space-filling design. 
* **Superimposed plots**: superimposed plots of one-shot homGP, one-shot hetGP, sequential hetGP fits over the "truth" hetGP fit on dense grided design.
