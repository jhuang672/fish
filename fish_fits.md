...
This file generates three kinds of surrogate models on the fish
agent-based model:
...
plot(xgrid* (upper_b - lower_b) + lower_b, p.hom$mean, type = "l",xlab = "Population", ylab = "Number of Marked in Recapture",   
...
``` r
## in original scale for population: 
plot(xgrid* (upper_b - lower_b) + lower_b, p.het$mean, type = "l",xlab = "Population", ylab = "Number of Marked in Recapture",   
...
``` r
## in original scale for population: 
plot(xgrid* (upper_b - lower_b) + lower_b, p.seq$mean, type = "l",xlab = "Population", ylab = "Number of Marked in Recapture",   
...
``` r
## plot
hist(x.ABC.native, breaks = 30, probability = T, main="ABC calibration using hetGP surrogate", xlab = 'N') ## plot histogram
```
